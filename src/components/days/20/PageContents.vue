...
onMounted(async () => {
  ...
  viewer.camera.flyTo({
    destination: Cartesian3.fromDegrees(140.060059, 35.618784, 90),
    orientation: {
      heading: CesiumMath.toRadians(150.0),
  ...
  try {
    ...
    const dataSource = await viewer.dataSources.add(CzmlDataSource.load(`${baseUrl}/days/20/marathon.czml`))
