...
onMounted(() => {
  ...
  map.on('load', () => {
    ...
    map.addLayer({
      ...
      paint: {
        'circle-color': '#d6d854',
        'circle-radius': ['interpolate', ['linear'], ['zoom'], 13, 10, 15, 5],
        'circle-blur': 3,
        'circle-opacity': 0.4,
      },
    })
    map.addLayer({
      ...
      paint: {
        'circle-color': '#ffff00',
        'circle-radius': ['interpolate', ['linear'], ['zoom'], 13, 5, 15, 2],
        'circle-blur': 3,
        'circle-opacity': 0.4,
      },
    })
    map.addLayer({
      ...
      type: 'circle',
      paint: {
        'circle-color': ['interpolate', ['linear'], ['zoom'], 13, '#ffffff', 15, '#ffd'],
        'circle-radius': ['interpolate', ['linear'], ['zoom'], 12, 1, 15, 3],
        'circle-blur': 0,
        'circle-opacity': 1,
      },
    })
